...
namespace BlackHawkDown
{
    class Blackhawk : Vehicles
    {
        ...
        {
            //updates passenger seats and passengers myvec field when they enter
            if (_p1 == null)
            {
                _p1 = mountee;
                mountee.myvec = this;
                AO[mountee.coordinatex, mountee.coordinatey] = "";
                mountee.coordinatex = this.coordinatex;
                mountee.coordinatey = this.coordinatey;
        ...
        {
            //updates passenger seats and passengers myvec field when they leave
            if (_p1 != null)
            {
                if (_p1.name == mountee.name && _p1 != null)
                {
                    ...
                    mountee.myvec = null;
                    AO[mountee.coordinatex, mountee.coordinatey] = "";
                    mountee.coordinatex = this.coordinatex - 1;
                    mountee.coordinatey = this.coordinatey - 3;
            ...
            else if (_p2 != null)
            {
                if (_p2.name == mountee.name && _p2 != null)
                {
                    ...
                    AO[mountee.coordinatex, mountee.coordinatey] = "";
                    mountee.coordinatex = this.coordinatex - 1;
                    mountee.coordinatey = this.coordinatey - 2;
                    AO[mountee.coordinatex, mountee.coordinatey] = $"{mountee.name}";
            ...
            else if (_p3 != null)
            {
                if (_p3.name == mountee.name && _p3 != null)
                {
                    ...
                    AO[mountee.coordinatex, mountee.coordinatey] = "";
                    mountee.coordinatex = this.coordinatex - 1;
                    mountee.coordinatey = this.coordinatey - 1;
                    AO[mountee.coordinatex, mountee.coordinatey] = $"{mountee.name}";
