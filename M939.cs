    ...
    class M939 : Vehicles
    {
        ...
        public void MountPassenger(Person pers, string[,] AO)
        {
            if (_p1 == null)
            {
                ...
                pers.coordinatex = this.coordinatex;
                pers.coordinatey = this.coordinatey;
        ...
        public void DismountPassenger(Person pers, string[,] AO)
        {
            if (_p1 != null)
            {
                if (_p1.name == pers.name)
                {
                    ...
                    pers.myvec = null;
                    AO[pers.coordinatex, pers.coordinatey] = "";
                    pers.coordinatex = this.coordinatex - 1;
                    pers.coordinatey = this.coordinatey - 4;
            ...
            else if (_p2 != null)
            {
                if (_p2.name == pers.name)
                {
                    ...
                    AO[pers.coordinatex, pers.coordinatey] = "";
                    pers.coordinatex = this.coordinatex - 1;
                    pers.coordinatey = this.coordinatey - 3;
                    AO[pers.coordinatex, pers.coordinatey] = $"{pers.name}";
            ...
            else if (_p3 != null)
            {
                if (_p3.name == pers.name)
                {
                    ...
                    AO[pers.coordinatex, pers.coordinatey] = "";
                    pers.coordinatex = this.coordinatex - 1;
                    pers.coordinatey = this.coordinatey - 2;
                    AO[pers.coordinatex, pers.coordinatey] = $"{pers.name}";
            ...
            else if (_p4 != null)
            {
                if (_p4.name == pers.name)
                {
                    ...
                    AO[pers.coordinatex, pers.coordinatey] = "";
                    pers.coordinatex = this.coordinatex - 1;
                    pers.coordinatey = this.coordinatey - 1;
                    AO[pers.coordinatex, pers.coordinatey] = $"{pers.name}";
